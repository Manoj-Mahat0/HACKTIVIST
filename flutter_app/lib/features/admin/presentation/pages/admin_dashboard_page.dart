                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: const Text('Manage building offline status'),
                        trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: const Text('Map building areas with GPS'),
                        trailing: const Icon(Icons.arrow_forward_ios, size: 16),
              ...
              children: [
                ...
                ListTile(
                  leading: Container(
                    ...
                    child: Icon(Icons.tour, color: Colors.amber.shade700),
                  ),
                  title: const Text('Show Tour'),
                ...
                ListTile(
                  leading: Container(
                    ...
                    child: Icon(Icons.refresh, color: Colors.green.shade600),
                  ),
                  title: const Text('Refresh Data'),
                  subtitle: const Text('Reload analytics and buildings'),
                  trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                  onTap: () {
                    context.read<AdminBloc>().add(LoadAnalyticsEvent());
                    ScaffoldMessenger.of(context).showSnackBar(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'AR/VR Indoor Navigation System',
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: Colors.grey.shade600,
                    ),
                  ),
