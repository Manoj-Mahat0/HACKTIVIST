...
class _OfflineBuildingManagementPageState extends State<OfflineBuildingManagementPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Offline Boundary'),
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(icon: Icon(Icons.business), text: 'Boundary'),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Create Boundary'),
    ...
    return BlocConsumer<OfflineBloc, OfflineState>(
      listener: (context, state) {
        if (state is OfflineBuildingCreated) {
          ...
          Fluttertoast.showToast(
            msg: '$synced Boundary synced successfully!',
            backgroundColor: Colors.green,
          );
          _loadData();
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            icon: const Icon(Icons.add_location_alt),
            label: const Text('Create Your First Boundary'),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    '$pendingCount Boundary ready to sync',
